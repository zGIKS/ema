...
from src.app.identification.domain.model.entities import FaceSample, PersonAggregate
from src.app.identification.domain.model.results import IdentificationMatchResult
...
from src.app.identification.infrastructure.persistence.sqlalchemy.models.PersonEmbeddingModel import (
    PersonEmbeddingModel,
)
from src.app.identification.infrastructure.persistence.sqlalchemy.models.PersonModel import (
    PersonModel,
)
